      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="p-6 bg-black/60 font-mono text-sm sm:text-base text-gray-300 leading-relaxed overflow-x-auto">
              ...
              <div className="pl-8 mt-2 text-gray-400"># 3. SSH & Restart Services</div>
              <div className="pl-12 text-blue-400">- run: <span className="text-green-400">ssh deploy@prod "docker-compose up -d"</span></div>
